 ...
 *
 */
public class ReminderManager implements Iterable<Reminder>, ListenerSupport {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof ReminderManager // instanceof handles nulls
                && internalList.equals(((ReminderManager) other).internalList));
    }
    ...
    public void propertyChange(Evt evt) {
        if (evt.getPropertyName().equals("statusChange")) {
            logger.info("ReminderManager notified of change of state.");
