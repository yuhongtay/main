 ...
 *
 */
public class ExpenseTrackerList implements Iterable<Tracker> {

    private final ObservableList<Tracker> internalList = FXCollections.observableArrayList();

    /**
     * Returns true if the list contains an equivalent person as the given argument.
     */
    public boolean contains(Tracker toCheck) {
     ...
     */
    public void setTracker(Tracker target, Tracker editedTracker) {
     ...
     */
    public void remove(Tracker toRemove) {
     ...
     */
    public void setEntries(List<Tracker> entries) {
     ...
     */
    public ObservableList<Tracker> asUnmodifiableObservableList() {
        return internalList;
    }
