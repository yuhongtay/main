...
* `addBudget c/Entertainment n/Nov Budget a/500.00 d/2019 11 01 p/1m t/fun`
...
.. `findIncome [cat/<category>] [n/<description>] amt/<amount>] [d/<date>] [t/<tag>]`
.. `findBudget [cat/<category>] [n/<description>] [d/<date>] [t/<tag>]`
.. `findWish [cat/<category>] [n/<description>] [amt/<amount>] [d/<date>] [t/<tag>]`
...
. Wishlist:
.. `addWish n/<Description> c/<Category> amt/<Price> d/<Date>`
.. `deleteWish <index>`
.. `editWishlist <index> [n/<Description>] [c/<Category>] [amt/<Price>] [d/<Date>] [t/<Tag>]`
...
.. `findWish [c/<category>] [n/<description>] [amt/<amount>] [d/<date>] [t/<tag>]`
.. `purchase <index>`
