...
Format: `addExpense cat/<category> n/<description> amt/<expenditure> d/<date> [tg/<tag>]`
...
* `addExpense cat/Gifts typ/Expense n/Rubber Duck for Yee Jian amt/55 d/2019 11 09 tg/sanity check`
* `addExpense cat/Travel typ/Expense n/Travel To Alaska amt/550000 d/2019 09 09`
...
* `addIncome cat/Gifts typ/Income n/Durian a/200.00 d/2019 09 09 tg/food`
* `addIncome cat/Business typ/Income n/business Trip To Mars a/20000.00 d/2019 09 09`
...
Format: `editExpense <index> [cat/<category>] [n/<description>] [d/<date>] [amt/<expenditure>] [tg/<tag>]`
...
Format: `addReminder n/<Message> [typ/<EntryType>] [l.b/<LowerBound>] [u.b/<UpperBound>] [start/<Start Date>] [end/<End Date]`
